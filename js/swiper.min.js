    ...
    t = function (e, s) {
      ...
      function p(e) {
        ...
        if (
          ...
          if (37 === a || 39 === a || 38 === a || 40 === a) {
            var t = !1;
            if (
              T.container.parents(".swiper-slide").length > 0 &&
              0 === T.container.parents(".swiper-slide-active").length
            )
              return;
      ...
      function u(e) {
        ...
        if (0 !== t) {
          if ((T.params.mousewheelInvert && (t = -t), T.params.freeMode)) {
            var s =
                T.getWrapperTranslate() + t * T.params.mousewheelSensitivity,
              n = T.isBeginning,
              o = T.isEnd;
            if (
          ...
          return (
            T.params.autoplay && T.stopAutoplay(),
            e.preventDefault ? e.preventDefault() : (e.returnValue = !1),
            !1
          );
        }
      ...
      for (var v in s)
        if (
          ...
          s[v] === window ||
          s[v] === document ||
          ("undefined" != typeof r && s[v] instanceof r) ||
      ...
      if (
        ...
        (T.container[0].swiper = T),
          ...
          T.support.flexbox ||
            (T.classNames.push("swiper-container-no-flexbox"),
            (T.params.slidesPerColumn = 1)),
          T.params.autoHeight &&
            T.classNames.push("swiper-container-autoheight"),
          (T.params.parallax || T.params.watchSlidesVisibility) &&
            (T.params.watchSlidesProgress = !0),
          ["cube", "coverflow"].indexOf(T.params.effect) >= 0 &&
            (T.support.transforms3d
              ? ((T.params.watchSlidesProgress = !0),
                T.classNames.push("swiper-container-3d"))
              : (T.params.effect = "slide")),
          "slide" !== T.params.effect &&
            T.classNames.push("swiper-container-" + T.params.effect),
          ...
          T.params.pagination &&
            ((T.paginationContainer = a(T.params.pagination)),
            T.params.paginationClickable &&
              T.paginationContainer.addClass("swiper-pagination-clickable")),
          (T.rtl =
            i() &&
          ...
          T.params.slidesPerColumn > 1 &&
            T.classNames.push("swiper-container-multirow"),
          ...
          (T.startAutoplay = function () {
            return "undefined" != typeof T.autoplayTimeoutId
              ? !1
              : T.params.autoplay
              ? T.autoplaying
                ? !1
                : ((T.autoplaying = !0), T.emit("onAutoplayStart", T), void o())
              : !1;
          }),
          ...
          (T.updateAutoHeight = function () {
            ...
            e &&
              T.wrapper.css(
                "height",
                T.slides.eq(T.activeIndex)[0].offsetHeight + "px"
              );
          }),
          (T.updateContainerSize = function () {
            var e, a;
            (e =
              "undefined" != typeof T.params.width
                ? T.params.width
                : T.container[0].clientWidth),
              (a =
                "undefined" != typeof T.params.height
                  ? T.params.height
              ...
              "none" !== c.css("display") &&
                ("auto" === T.params.slidesPerView
                  ...
                  : ((l =
                    ...
                    T.params.roundLengths && (l = n(l)),
                    i()
                      ? (T.slides[e].style.width = l + "px")
                      : (T.slides[e].style.height = l + "px")),
          ...
          (T.updateSlidesOffset = function () {
            for (var e = 0; e < T.slides.length; e++)
              T.slides[e].swiperSlideOffset = i()
          ...
          (T.updateSlidesProgress = function (e) {
            if (
              ...
              "undefined" == typeof T.slides[0].swiperSlideOffset &&
              ...
              for (var t = 0; t < T.slides.length; t++) {
                var r = T.slides[t],
                  s =
                    ...
                    (r.swiperSlideSize + T.params.spaceBetween);
          ...
          (T.updateClasses = function () {
            ...
            if (
              ...
              T.params.loop
                ? ((t =
                    Math.ceil(T.activeIndex - T.loopedSlides) /
                    T.params.slidesPerGroup),
                  t > T.slides.length - 1 - 2 * T.loopedSlides &&
                ...
                T.paginationContainer.length > 1
                  ? T.bullets.each(function () {
                      a(this).index() === t &&
                        a(this).addClass(T.params.bulletActiveClass);
                    })
            ...
            T.params.loop ||
              (T.params.prevButton &&
                (T.isBeginning
                  ? (a(T.params.prevButton).addClass(
                      T.params.buttonDisabledClass
                    ),
                    T.params.a11y &&
                      T.a11y &&
                      T.a11y.disable(a(T.params.prevButton)))
                  : (a(T.params.prevButton).removeClass(
                      T.params.buttonDisabledClass
                    ),
                    T.params.a11y &&
                      T.a11y &&
                      T.a11y.enable(a(T.params.prevButton)))),
              T.params.nextButton &&
                (T.isEnd
                  ? (a(T.params.nextButton).addClass(
                      T.params.buttonDisabledClass
                    ),
                    T.params.a11y &&
                      T.a11y &&
                      T.a11y.disable(a(T.params.nextButton)))
                  : (a(T.params.nextButton).removeClass(
                      T.params.buttonDisabledClass
                    ),
                    T.params.a11y &&
                      T.a11y &&
                      T.a11y.enable(a(T.params.nextButton)))));
          }),
        ...
        window.navigator.pointerEnabled
          ...
          (T.touchEvents = {
            start:
              T.support.touch || !T.params.simulateTouch ? "touchstart" : x[0],
            move:
              T.support.touch || !T.params.simulateTouch ? "touchmove" : x[1],
          ...
          (T.initEvents = function (e) {
            ...
            T.browser.ie
              ? (i[r](T.touchEvents.start, T.onTouchStart, !1),
                n[r](T.touchEvents.move, T.onTouchMove, o),
                n[r](T.touchEvents.end, T.onTouchEnd, !1))
              : (T.support.touch &&
                  (i[r](T.touchEvents.start, T.onTouchStart, !1),
                ...
                !s.simulateTouch ||
                  T.device.ios ||
                  T.device.android ||
                  (i[r]("mousedown", T.onTouchStart, !1),
                  document[r]("mousemove", T.onTouchMove, o),
                  document[r]("mouseup", T.onTouchEnd, !1))),
              window[r]("resize", T.onResize),
              T.params.nextButton &&
                (a(T.params.nextButton)[t]("click", T.onClickNext),
                T.params.a11y &&
                  T.a11y &&
                  a(T.params.nextButton)[t]("keydown", T.a11y.onEnterKey)),
              T.params.prevButton &&
                (a(T.params.prevButton)[t]("click", T.onClickPrev),
                T.params.a11y &&
                  T.a11y &&
                  a(T.params.prevButton)[t]("keydown", T.a11y.onEnterKey)),
              T.params.pagination &&
                T.params.paginationClickable &&
                (a(T.paginationContainer)[t](
                  "click",
                  "." + T.params.bulletClass,
                  T.onClickIndex
                ),
            ...
            if (
              ...
              if (T.params.loop) {
                ...
                (i = a(T.clickedSlide).attr("data-swiper-slide-index")),
                  T.params.centeredSlides
                    ? n < T.loopedSlides - T.params.slidesPerView / 2 ||
                      n >
                        T.slides.length -
                          T.loopedSlides +
                          T.params.slidesPerView / 2
                      ? (T.fixLoop(),
                        (n = T.wrapper
                          .children(
                            "." +
        ...
        if (
          ...
          (T.onTouchMove = function (e) {
            if (
              ...
              if (
                ...
                if (
                  (P && T.emit("onTouchMoveOpposite", T, e),
                  "undefined" == typeof N &&
                    T.browser.ieTouch &&
            ...
            if (
              ...
              if (
                (T.allowClick &&
                    ...
                    (L = setTimeout(function () {
                      T &&
                        (T.params.paginationHide &&
                          T.paginationContainer.length > 0 &&
                          !a(e.target).hasClass(T.params.bulletClass) &&
                  ...
                  300 > r &&
                    300 > t - G &&
                    (L && clearTimeout(L), T.emit("onDoubleTap", T, e))),
                (G = Date.now()),
                setTimeout(function () {
                  T && (T.allowClick = !0);
                }, 0),
              ...
              if (
                ...
                if (T.params.freeModeMomentum) {
                  ...
                  if (u < T.maxTranslate())
                    ...
                    (u =
                      Math.abs(T.snapGrid[h] - u) <
                        Math.abs(T.snapGrid[h - 1] - u) ||
                      "next" === T.swipeDirection
                        ? T.snapGrid[h]
                        : T.snapGrid[h - 1]),
                      T.rtl || (u = -u);
                ...
                return void (
                  (!T.params.freeModeMomentum || r >= T.params.longSwipesMs) &&
              ...
              for (v = 0; v < T.slidesGrid.length; v += T.params.slidesPerGroup)
                "undefined" != typeof T.slidesGrid[v + T.params.slidesPerGroup]
                  ? s >= T.slidesGrid[v] &&
                    s < T.slidesGrid[v + T.params.slidesPerGroup] &&
                    ((w = v),
                    (y =
              ...
              if (r > T.params.longSwipesMs) {
                ...
                "next" === T.swipeDirection &&
                  (b >= T.params.longSwipesRatio
                    ? T.slideTo(w + T.params.slidesPerGroup)
                    : T.slideTo(w)),
                  "prev" === T.swipeDirection &&
                    (b > 1 - T.params.longSwipesRatio
                      ? T.slideTo(w + T.params.slidesPerGroup)
                      : T.slideTo(w));
              } else {
          ...
          (T.slideTo = function (e, a, t, r) {
            ...
            T.params.autoplay &&
              T.autoplaying &&
              (r || !T.params.autoplayDisableOnInteraction
                ? T.pauseAutoplay(a)
                : T.stopAutoplay()),
              T.updateProgress(s);
            for (var i = 0; i < T.slidesGrid.length; i++)
              -Math.floor(100 * s) >= Math.floor(100 * T.slidesGrid[i]) &&
                (e = i);
            ...
            i() ? (r = T.rtl ? -e : e) : (s = e),
              ...
              T.params.virtualTranslate ||
                (T.support.transforms3d
                  ...
                  : T.wrapper.transform("translate(" + r + "px, " + s + "px)")),
              (T.translate = i() ? r : s);
            var l,
          ...
          (T.initObservers = function () {
            if (T.params.observeParents)
              for (var e = T.container.parents(), a = 0; a < e.length; a++)
                d(e[a]);
            d(T.container[0], { childList: !1 }),
              d(T.wrapper[0], { attributes: !1 });
          }),
          ...
          (T.createLoop = function () {
            ...
            "auto" !== T.params.slidesPerView ||
              ...
              (T.params.loopedSlides = e.length),
            ...
            for (
              ...
              T.wrapper.append(
                a(s[t].cloneNode(!0)).addClass(T.params.slideDuplicateClass)
              );
            for (t = r.length - 1; t >= 0; t--)
              T.wrapper.prepend(
                a(r[t].cloneNode(!0)).addClass(T.params.slideDuplicateClass)
              );
          }),
          ...
          (T.effects = {
            ...
            cube: {
              setTranslate: function () {
                ...
                T.params.cube.shadow &&
                  (i()
                    ? ((e = T.wrapper.find(".swiper-cube-shadow")),
                      0 === e.length &&
                        ((e = a('<div class="swiper-cube-shadow"></div>')),
                        T.wrapper.append(e)),
                      e.css({ height: T.width + "px" }))
                ...
                for (var r = 0; r < T.slides.length; r++) {
                  ...
                  r % 4 === 0
                    ...
                    : (r - 3) % 4 === 0 &&
                      ((d = -T.size), (u = 3 * T.size + 4 * T.size * o)),
                    T.rtl && (d = -d),
                    i() || ((p = d), (d = 0));
                  var c =
                    "rotateX(" +
            ...
            coverflow: {
              setTranslate: function () {
                for (
                  var e = T.translate,
                    t = i() ? -e + T.width / 2 : -e + T.height / 2,
                    r = i()
                      ? T.params.coverflow.rotate
                      : -T.params.coverflow.rotate,
                    s = T.params.coverflow.depth,
                    n = 0,
                    o = T.slides.length;
                  o > n;
                  n++
          ...
          (T.lazy = {
            ...
            loadImageInSlide: function (e, t) {
              if (
                "undefined" != typeof e &&
                ("undefined" == typeof t && (t = !0), 0 !== T.slides.length)
              ) {
                var r = T.slides.eq(e),
                  s = r.find(
            ...
            load: function () {
              ...
              if (T.params.watchSlidesVisibility)
                ...
                for (
                  e = T.activeIndex;
                  e < T.activeIndex + T.params.slidesPerView;
                  e++
                )
            ...
            setTranslate: function (e, a) {
              function r(a) {
                (e =
                  ...
                  (i && "container" !== T.params.controlBy) ||
                    ((s =
          ...
          T.mousewheel.event ||
            ...
            (T.mousewheel.event = "mousewheel"),
            T.mousewheel.event || (T.mousewheel.event = "DOMMouseScroll");
        }
        (T.disableMousewheelControl = function () {
          return T.mousewheel.event
            ? (T.container.off(T.mousewheel.event, u), !0)
            : !1;
        }),
          (T.enableMousewheelControl = function () {
            return T.mousewheel.event
              ? (T.container.on(T.mousewheel.event, u), !0)
              : !1;
          }),
          (T.parallax = {
            setTranslate: function () {
        ...
        return (
          (e.prototype = {
            ...
            prepend: function (a) {
              ...
              for (t = 0; t < this.length; t++)
                if ("string" == typeof a) {
                  var s = document.createElement("div");
                  for (
                    s.innerHTML = a, r = s.childNodes.length - 1;
                    r >= 0;
                    r--
                  )
                    this[t].insertBefore(
            ...
            find: function (a) {
              for (var t = [], r = 0; r < this.length; r++)
                for (
                  var s = this[r].querySelectorAll(a), i = 0;
                  i < s.length;
                  i++
                )
                  t.push(s[i]);
            ...
            children: function (t) {
              for (var r = [], s = 0; s < this.length; s++)
                for (var i = this[s].childNodes, n = 0; n < i.length; n++)
                  t
                    ? 1 === i[n].nodeType && a(i[n]).is(t) && r.push(i[n])
                    : 1 === i[n].nodeType && r.push(i[n]);
